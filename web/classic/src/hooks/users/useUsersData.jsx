...
import { useSubscriptionSummary } from '../../transwork/users/useSubscriptionSummary';
...
export const useUsersData = () => {
  ...
  const { subscriptionSummary, loadSubscriptionSummary } = useSubscriptionSummary();
