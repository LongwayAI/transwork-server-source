...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			transwork.RegisterChannelRoutes(channelRoute)
		...
		transwork.RegisterAPIRoutes(apiRouter)
	...
	// Root-level public route (no /api prefix, registered on the root router so it
	// is intentionally outside the apiRouter group and its middlewares).
	transwork.RegisterPublicRoutes(router)
}
